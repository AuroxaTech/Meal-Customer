...
class AppColor {
  ...
  static Color get primary => const Color(0xff29798F);

  static Color get primaryContainer => const Color(0xff2F8DA7);
  ...
  static Color get faintBgColor {
    try {
      final isLightMode =
          StackedService.navigatorKey?.currentContext?.brightness ==
              Brightness.light;
