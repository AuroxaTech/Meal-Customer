...
class SetOtpPage extends StatefulWidget {
  SetOtpPage({
    this.phone,
    Key? key,
  }) : super(key: key);
  ...
  final String? phone;
  @override
  _SetOtpPageState createState() => _SetOtpPageState();
}

class _SetOtpPageState extends State<SetOtpPage> {
              ...
              child: VStack(
                [
                  ...
                  VStack(
                    [
                      //
                      "Enter Otp".text.xl2.fontFamily(AppFonts.appFont).semiBold.make(),
                      ...
                      Form(
                        ...
                        child: VStack(
                          [
                            "${widget.phone}".tr().text.xl.fontFamily(AppFonts.appFont).semiBold.make(),
