...
import 'package:mealknight/views/pages/welcome/widgets/modern.welcome.empty.dart';
import 'package:mealknight/views/pages/welcome/widgets/plain.welcome.empty.dart';
import 'package:mealknight/views/pages/welcome/widgets/welcome.empty.dart';
...
class HomeScreenConfig {
  ...
  static Widget homeScreen(vm, key) {
    ...
    style = int.tryParse(uiEnv['home']["homeViewStyle"].toString()) ?? 1;
    Widget ui;
    switch (style) {
      case 1:
