...
import 'package:mealknight/models/order_attachment.dart';
import 'package:mealknight/models/order_fee.dart';
import 'package:mealknight/models/order_service.dart';
import 'package:mealknight/models/order_status.dart';
import 'package:mealknight/models/order_stop.dart';
import 'package:mealknight/models/package_type.dart';
import 'package:mealknight/models/taxi_order.dart';
...
class Order {
  ...
  bool get canCancel {
    if (['cancelled', 'failed', 'successful', 'completed', 'delivered']
        .contains(status)) {
      return false;
    }
  ...
  bool get canRateDriver {
    return rateDriver && driverId != null && ["delivered"].contains(status);
  }

  bool get canRateFood {
