...
import 'package:mealknight/constants/app_text_styles.dart';
      ...
      child: ElevatedButton(
          ...
          shape: this.shape ??
              RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(this.shapeRadius ?? Vx.dp4),
                  side: BorderSide(color: this.borderColor ?? Colors.transparent,width: 2)
              ),
        ),
        ...
        child: this.loading
            ...
            : Container(
                ...
                height: this.isFixedHeight ? Vx.dp48 : this.height ,
                child: this.child ??
                    Row(
